...
# qemu
QEMU		:= QEMU_AUDIO_DRV="none" qemu-system-x86_64 
QEMUOPTS	:= -device sb16 -smp 4 -hda $(CERTIKOS_IMG) -serial mon:stdio -gdb tcp::$(GDBPORT) -m 2048 -k en-us -hdb certikos_disk.img
